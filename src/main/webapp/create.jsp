...
<link rel="stylesheet" type="text/css"
	href="./src/css/create/preview.css" />
<script type="text/javascript" src="./src/js/create/jquery-1.10.2.js" /></script>
<script type="text/javascript"
	src="./src/js/create/jquery-ui-1.10.4.custom.js" /></script>
</head>

<body id="body">
	<div id="wrap">
		<header id="header">
			<span> <a href="/collageJam/main.next">CollageJam</a>
			</span>
		</header>
		<div id="navigation">
			<ul>
		...
		<section id="musicSelectWrap">
			<article>
				<div id="player2"></div>
				<div>
					<p>search n select n set time</p>
			...
			<div>
				...
				<div id="setting">
					<div>
						...
						<div>
							<input type="range" min="0" max="500" value="5" step="5"
